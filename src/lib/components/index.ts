...
import ContactCard from "$lib/components/Contact/Contact.svelte";
...
import TreadList from "$lib/components/Tread/List/List.svelte";
import Trends from "$lib/partials/Trends.svelte";
